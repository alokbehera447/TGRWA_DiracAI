...
def fill_diracai_blog_content_placeholders(apps, schema_editor):
    ...
    for slug in slugs:
        ...
        if not getattr(obj, "canonical_url", "") and canonical:
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(fill_diracai_blog_content_placeholders, migrations.RunPython.noop),
    ]
